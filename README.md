...
**このプロジェクトは Azuretest Firebase プロジェクト専用です。**
- Firebaseのデプロイ操作は必ず Azuretest プロジェクトに対してのみ実行してください
- 他のFirebaseプロジェクト（mutimon-34914等）は絶対に変更しないでください
- デプロイ前に `firebase use` コマンドで正しいプロジェクトが選択されていることを確認してください
